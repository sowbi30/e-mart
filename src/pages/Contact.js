...
<div className="col-12 p-3">
      ...
      <div className="container" style={{background:'lightgreen',border:'1px solid purple',paaddingTop:'5px'}}>
        <div className="contact-form">
          <form
            ...
            <input
              ...
              required
              autoComplete="off"
              style={{paddingTop:'2px',background:'lavender'}}
            />
            ...
            <input type="submit" style={{background:'purple',justifySelf:'center'}}value="send" />
          </form>
          </div>
